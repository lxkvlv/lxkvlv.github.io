        ...
        if ( change_background != false && change_bg_check() ){
            ...
            if (section_custom_background !== undefined && section_custom_background != "")
            {
                ...
                $(function() {
                  ...
                  if (overlay_enabled) $.vegas('overlay', { src:'/img/theme_images/background-image-overlay-full.png', opacity:overlay_opacity });
                });
            }
 ...
 function reset_captcha(form_object)
 {
    ...
    forms.each(function(){
        ...
        if (captcha.length > 0 && this_form.is(":visible")) {
            ...
            captcha.replaceWith('<img id="form-captcha-img" src="/php/form_captcha/captcha_img.php?t='+d+'" style="display:none">');
